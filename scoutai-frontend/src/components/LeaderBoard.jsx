              ...
              <div className="grid grid-cols-12 gap-4 px-6 py-5 items-center hover:bg-white/5 transition-all">
                ...
                <div className="col-span-2 text-right flex justify-end items-center gap-2">
                  ...
                  <a 
                    ...
                    className="inline-flex items-center justify-center p-2 rounded-lg bg-white/5 border border-white/10 text-slate-400 hover:text-primary-blue hover:border-primary-blue/30 transition-all"
